...
// import { BorrowDetails } from "./model";
// import { UserArrayList } from "./model";
// import { BookDetailsList } from "./model";
// import { BorrowDetailsList } from "./model";
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (bookData) {
                ...
                // bookData.ExpiryDate = new Date(Number(dateSplit[0]), (Number(dateSplit[1]) - 1), (Number(dateSplit[2])));
            ...
            BookDetailsList.forEach(function (book) {
                if (book.BookID == bookID) {
                    if (book.Availability == "available") {
                        ...
                        console.log(newDate);
                        alert("The book is issued.The book will be available on ".concat(newDate));
                    }
                    else {
        ...
        return __generator(this, function (_a) {
            ...
            BorrowDetailsList.forEach(function (borrow) {
                if (borrow.UserID == currentUser.UserId) {
                    ...
                    // <td><button id="cancelbtn" onclick="return('${borrow.BorrowID}')">Return</button></td>`;
